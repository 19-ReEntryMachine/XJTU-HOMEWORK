...
n=150;
pic=ones(n,n,3)*255;img=image(pic);indi=zeros(n,n,5);
...
control=1;sum=ones(5);num=zeros(5);selfrate=[0.15,0.25,0.33,0.45,0.58];condirate=[0.967;0.7;0.58;0.478;0.428];
